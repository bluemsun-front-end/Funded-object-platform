                      ...
                      <div class="change">
                          ...
                          <div class="changeInfor">
                            <el-form-item style="font-size: 20px;" >
                              ...
                              <el-select v-model="editInfo.status" placeholder="状态" style="width: 150px;">
                                  <el-option
...
const editInfo = reactive({
  ...
  try {
      const response = await axios.get('http://59.110.62.188:8080/grow/userOwnInfo/list', {
        params: {},
      });
...
const saveEditInfo = async () => {
  if (editForm.value) {
    try {
      ...
      const response = await axios.post('http://59.110.62.188:8080/grow/userInfo/updateUserInfo', dataToSubmit);
      if (response.data.code === 200) {
  ...
  const addExperience = async () => {
    try {
      const response = await axios.post('http://59.110.62.188:8080/grow/project/addProject', {
        pageSize: 8,
        pageNum: pageNum,
        startDate: newExperience.value.startDate,
        endDate: newExperience.value.endDate,
